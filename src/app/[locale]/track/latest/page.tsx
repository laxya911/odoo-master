        ...
        <div className="container mx-auto px-4 py-40 text-center max-w-lg">
            {status === 'searching' && (
                <div className="space-y-8 animate-pulse">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-3xl font-bold font-headline">{t('transmitting')}</h1>
                        <p className="text-muted-foreground">{t('transmittingDesc')}</p>
                    </div>
                </div>
            )}
            ...
            {status === 'found' && (
                <div className="space-y-8 animate-in fade-in zoom-in duration-500">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-3xl font-bold font-headline">{t('orderConfirmed')}</h1>
            ...
            {status === 'error' && (
                <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-3xl font-bold font-headline">{t('syncDelay')}</h1>
                        <p className="text-muted-foreground">{t('syncDelayDesc')}</p>
                        <button
